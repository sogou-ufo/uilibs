jQuery.UUIBase.css.push(".uuiDrag-main-dragging *{-moz-user-select:none;-webkit-user-select:none;-ms-user-select:none;-khtml-user-select:none;user-select:none}.uuiDrag-dragger{z-index:9000}");/**
 * 组件
