...
<head>
    <meta charset="utf-8">
    <title>jQuery ui plugin uuiZhengxin</title>
    <style type="text/css">
    ...
    <script src="./build/js/mobile.uuiZhengxin.js"></script>
    <?php }else{ ?>
    <script src="./js/uuiZhengxin.js"></script>
    <?php }?>
...
<div class="header">
        <h1>
            ...
            uuiZhengxin TEST page
        </h1>
    </div>
    <div class="content">
        <div class="content-inner">
            <p><a href="./doc/uuiZhengxin/index.html" target="_blank">preview doc[exc "ui doc first"]</a></p>
            <br />
                <p>                                                                                                           
                <?php if(isset($_GET['mobile'])){ ?>                                                                      
...
$('#uuiZhengxinBox').uuiZhengxin({});
            </textarea>
            <input type=button value="run test" onclick="eval($('#code').attr('value'))"/>
            <p>test dom here:</p>
            <div id="uuiZhengxinBox" style="background:#fff;padding:10px;">uuiZhengxin Test</div>
        </div>
    </div>
    <div class="footer">
